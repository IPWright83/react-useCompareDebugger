 ...
 */
const deepCompare = (previousProps, currentProps, ignoreKeys = [], depth = 0, lastKey = undefined) => {
    ...
    for (const _key of keys) {
        ...
        const _isObject = (0, utils_1.isObject)(_current);
        const _isArray = Array.isArray(_current);
        const _isFunction = (0, utils_1.isFunction)(_current);
        ...
        result[_key] = item;
        (0, log_1.logValue)(_key, _previous, _current);
    }
    return result;
};
